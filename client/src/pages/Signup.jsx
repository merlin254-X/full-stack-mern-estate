...
import { deleteUserSuccess, signOutUserStart } from '../redux/user/userSlice';
  ...
  return (
    <div className="fixed inset-0 z-[60] overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center px-4 pointer-events-none">
        ...
        >
          <h1 className="text-3xl text-center font-semibold text-[#111111]">Sign up</h1>
          <p className="mt-2 text-center text-sm text-black/50">Create an account to continue.</p>
          ...
          <form className="mt-6" onSubmit={handleSubmit}>
            <label className="block text-sm text-[#111111] mb-1">Username</label>
            <input
              type="text"
              name="username"
